...
#ifndef VST3BRIDGE_SWIFT_H
#define VST3BRIDGE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VST3Bridge",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("VST3Bridge", usrValue)
#ifndef SWIFT_PRINTED_CORE
#define SWIFT_PRINTED_CORE
namespace swift SWIFT_PRIVATE_ATTR {
...
#endif
#ifdef __cplusplus
namespace VST3Bridge SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("VST3Bridge") {
namespace _impl {
extern "C" {
#endif

// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_returnStub_VST3Bridge_void_ptr_0_8 {
  void * _Nullable _1;
};

static SWIFT_C_INLINE_THUNK void swift_interop_returnDirect_VST3Bridge_void_ptr_0_8(char * _Nonnull result, struct swift_interop_returnStub_VST3Bridge_void_ptr_0_8 value) {
  memcpy(result + 0, &value._1, 8);
}

SWIFT_EXTERN struct swift_interop_returnStub_VST3Bridge_void_ptr_0_8 $s10VST3Bridge0A8InstanceC10parametersSayAA0A9ParameterVGvg(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_passStub_VST3Bridge_void_ptr_0_8 {
  void * _Nullable _1;
};

static SWIFT_C_INLINE_THUNK struct swift_interop_passStub_VST3Bridge_void_ptr_0_8 swift_interop_passDirect_VST3Bridge_void_ptr_0_8(const char * _Nonnull value) {
  struct swift_interop_passStub_VST3Bridge_void_ptr_0_8 result;
  memcpy(&result._1, value + 0, 8);
  return result;
}

SWIFT_EXTERN void $s10VST3Bridge0A8InstanceC10parametersSayAA0A9ParameterVGvs(struct swift_interop_passStub_VST3Bridge_void_ptr_0_8 value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN bool $s10VST3Bridge0A8InstanceC7isSetUpSbvg(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s10VST3Bridge0A8InstanceC7isSetUpSbvs(bool value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN bool $s10VST3Bridge0A8InstanceC8isActiveSbvg(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s10VST3Bridge0A8InstanceC8isActiveSbvs(bool value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN bool $s10VST3Bridge0A8InstanceC5setup10sampleRate12maxBlockSize11numChannelsSbSi_S2itF(ptrdiff_t sampleRate, ptrdiff_t maxBlockSize, ptrdiff_t numChannels, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // setup(sampleRate:maxBlockSize:numChannels:)
SWIFT_EXTERN bool $s10VST3Bridge0A8InstanceC8activateSbyF(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // activate()
SWIFT_EXTERN bool $s10VST3Bridge0A8InstanceC10deactivateSbyF(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // deactivate()
SWIFT_EXTERN bool $s10VST3Bridge0A8InstanceC7process6inputs7outputs10midiEventsSbSaySaySfGG_AIzSayAA0A13MIDIEventDataVGtF(struct swift_interop_passStub_VST3Bridge_void_ptr_0_8 inputs, void * _Nonnull outputs, struct swift_interop_passStub_VST3Bridge_void_ptr_0_8 midiEvents, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // process(inputs:outputs:midiEvents:)
SWIFT_EXTERN double $s10VST3Bridge0A8InstanceC12getParameterySds6UInt32VF(uint32_t id, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // getParameter(_:)
SWIFT_EXTERN void $s10VST3Bridge0A8InstanceC12setParameter_5valueys6UInt32V_SdtF(uint32_t id, double value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // setParameter(_:value:)
SWIFT_EXTERN void $s10VST3Bridge0A8InstanceC9beginEdityys6UInt32VF(uint32_t id, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // beginEdit(_:)
SWIFT_EXTERN void $s10VST3Bridge0A8InstanceC7endEdityys6UInt32VF(uint32_t id, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // endEdit(_:)
SWIFT_EXTERN bool $s10VST3Bridge0A8InstanceC9hasEditorSbvg(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
#if defined(__OBJC__)
SWIFT_EXTERN bool $s10VST3Bridge0A8InstanceC10openEditor2inSbyXl_tF(id _Nonnull parentView, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // openEditor(in:)
#endif
SWIFT_EXTERN void $s10VST3Bridge0A8InstanceC11closeEditoryyF(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // closeEditor()
// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_passStub_VST3Bridge_uint64_t_0_8_uint32_t_8_12 {
  uint64_t _1;
  uint32_t _2;
};

static SWIFT_C_INLINE_THUNK struct swift_interop_passStub_VST3Bridge_uint64_t_0_8_uint32_t_8_12 swift_interop_passDirect_VST3Bridge_uint64_t_0_8_uint32_t_8_12(const char * _Nonnull value) {
  struct swift_interop_passStub_VST3Bridge_uint64_t_0_8_uint32_t_8_12 result;
  memcpy(&result._1, value + 0, 8);
  memcpy(&result._2, value + 8, 4);
  return result;
}

SWIFT_EXTERN ptrdiff_t $s10VST3Bridge0A13MIDIEventDataV12sampleOffsetSivg(struct swift_interop_passStub_VST3Bridge_uint64_t_0_8_uint32_t_8_12 _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s10VST3Bridge0A13MIDIEventDataV12sampleOffsetSivs(ptrdiff_t value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN uint8_t $s10VST3Bridge0A13MIDIEventDataV6statuss5UInt8Vvg(struct swift_interop_passStub_VST3Bridge_uint64_t_0_8_uint32_t_8_12 _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s10VST3Bridge0A13MIDIEventDataV6statuss5UInt8Vvs(uint8_t value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN uint8_t $s10VST3Bridge0A13MIDIEventDataV5data1s5UInt8Vvg(struct swift_interop_passStub_VST3Bridge_uint64_t_0_8_uint32_t_8_12 _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s10VST3Bridge0A13MIDIEventDataV5data1s5UInt8Vvs(uint8_t value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN uint8_t $s10VST3Bridge0A13MIDIEventDataV5data2s5UInt8Vvg(struct swift_interop_passStub_VST3Bridge_uint64_t_0_8_uint32_t_8_12 _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s10VST3Bridge0A13MIDIEventDataV5data2s5UInt8Vvs(uint8_t value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN uint8_t $s10VST3Bridge0A13MIDIEventDataV7channels5UInt8Vvg(struct swift_interop_passStub_VST3Bridge_uint64_t_0_8_uint32_t_8_12 _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s10VST3Bridge0A13MIDIEventDataV7channels5UInt8Vvs(uint8_t value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_returnStub_VST3Bridge_uint64_t_0_8_uint32_t_8_12 {
  uint64_t _1;
  uint32_t _2;
};

static SWIFT_C_INLINE_THUNK void swift_interop_returnDirect_VST3Bridge_uint64_t_0_8_uint32_t_8_12(char * _Nonnull result, struct swift_interop_returnStub_VST3Bridge_uint64_t_0_8_uint32_t_8_12 value) {
  memcpy(result + 0, &value._1, 8);
  memcpy(result + 8, &value._2, 4);
}

SWIFT_EXTERN struct swift_interop_returnStub_VST3Bridge_uint64_t_0_8_uint32_t_8_12 $s10VST3Bridge0A13MIDIEventDataV12sampleOffset6status5data15data27channelACSi_s5UInt8VA3JtcfC(ptrdiff_t sampleOffset, uint8_t status, uint8_t data1, uint8_t data2, uint8_t channel) SWIFT_NOEXCEPT SWIFT_CALL; // init(sampleOffset:status:data1:data2:channel:)
SWIFT_EXTERN struct swift_interop_returnStub_VST3Bridge_uint64_t_0_8_uint32_t_8_12 $s10VST3Bridge0A13MIDIEventDataV6noteOn12sampleOffset0E08velocity7channelACSi_s5UInt8VA2JtFZ(ptrdiff_t sampleOffset, uint8_t note, uint8_t velocity, uint8_t channel) SWIFT_NOEXCEPT SWIFT_CALL; // noteOn(sampleOffset:note:velocity:channel:)
SWIFT_EXTERN struct swift_interop_returnStub_VST3Bridge_uint64_t_0_8_uint32_t_8_12 $s10VST3Bridge0A13MIDIEventDataV7noteOff12sampleOffset0E08velocity7channelACSi_s5UInt8VA2JtFZ(ptrdiff_t sampleOffset, uint8_t note, uint8_t velocity, uint8_t channel) SWIFT_NOEXCEPT SWIFT_CALL; // noteOff(sampleOffset:note:velocity:channel:)
struct VST3Bridge_VST3MIDIEventData {
  _Alignas(8) char _storage[12];
};

// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_returnStub_VST3Bridge_uint64_t_0_8_void_ptr_8_16 {
  uint64_t _1;
  void * _Nullable _2;
};

static SWIFT_C_INLINE_THUNK void swift_interop_returnDirect_VST3Bridge_uint64_t_0_8_void_ptr_8_16(char * _Nonnull result, struct swift_interop_returnStub_VST3Bridge_uint64_t_0_8_void_ptr_8_16 value) {
  memcpy(result + 0, &value._1, 8);
  memcpy(result + 8, &value._2, 8);
}

SWIFT_EXTERN struct swift_interop_returnStub_VST3Bridge_uint64_t_0_8_void_ptr_8_16 $s10VST3Bridge0A6ModuleC4pathSSvg(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_VST3Bridge_void_ptr_0_8 $s10VST3Bridge0A6ModuleC7pluginsSayAA0A17PluginDescriptionVGvg(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s10VST3Bridge0A6ModuleC7pluginsSayAA0A17PluginDescriptionVGvs(struct swift_interop_passStub_VST3Bridge_void_ptr_0_8 value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_returnStub_VST3Bridge_uint64_t_0_8 {
  uint64_t _1;
};

static SWIFT_C_INLINE_THUNK void swift_interop_returnDirect_VST3Bridge_uint64_t_0_8(char * _Nonnull result, struct swift_interop_returnStub_VST3Bridge_uint64_t_0_8 value) {
  memcpy(result + 0, &value._1, 8);
}

// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_passStub_VST3Bridge_uint64_t_0_8_void_ptr_8_16 {
  uint64_t _1;
  void * _Nullable _2;
};

static SWIFT_C_INLINE_THUNK struct swift_interop_passStub_VST3Bridge_uint64_t_0_8_void_ptr_8_16 swift_interop_passDirect_VST3Bridge_uint64_t_0_8_void_ptr_8_16(const char * _Nonnull value) {
  struct swift_interop_passStub_VST3Bridge_uint64_t_0_8_void_ptr_8_16 result;
  memcpy(&result._1, value + 0, 8);
  memcpy(&result._2, value + 8, 8);
  return result;
}

SWIFT_EXTERN struct swift_interop_returnStub_VST3Bridge_uint64_t_0_8 $s10VST3Bridge0A6ModuleC4pathACSgSS_tcfC(struct swift_interop_passStub_VST3Bridge_uint64_t_0_8_void_ptr_8_16 path, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // init(path:)
SWIFT_EXTERN struct swift_interop_returnStub_VST3Bridge_uint64_t_0_8 $s10VST3Bridge0A6ModuleC14createInstance11pluginIndexAA0aE0CSgSi_tF(ptrdiff_t pluginIndex, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // createInstance(pluginIndex:)
SWIFT_EXTERN uint32_t $s10VST3Bridge0A9ParameterV2ids6UInt32Vvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_VST3Bridge_uint64_t_0_8_void_ptr_8_16 $s10VST3Bridge0A9ParameterV4nameSSvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_VST3Bridge_uint64_t_0_8_void_ptr_8_16 $s10VST3Bridge0A9ParameterV9shortNameSSvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_VST3Bridge_uint64_t_0_8_void_ptr_8_16 $s10VST3Bridge0A9ParameterV5unitsSSvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN double $s10VST3Bridge0A9ParameterV12defaultValueSdvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN double $s10VST3Bridge0A9ParameterV8minValueSdvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN double $s10VST3Bridge0A9ParameterV8maxValueSdvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN ptrdiff_t $s10VST3Bridge0A9ParameterV9stepCountSivg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN bool $s10VST3Bridge0A9ParameterV11canAutomateSbvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
struct VST3Bridge_VST3Parameter {
  _Alignas(8) char _storage[89];
};

SWIFT_EXTERN struct swift_interop_returnStub_VST3Bridge_uint64_t_0_8_void_ptr_8_16 $s10VST3Bridge0A17PluginDescriptionV2idSSvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_VST3Bridge_uint64_t_0_8_void_ptr_8_16 $s10VST3Bridge0A17PluginDescriptionV4nameSSvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_VST3Bridge_uint64_t_0_8_void_ptr_8_16 $s10VST3Bridge0A17PluginDescriptionV6vendorSSvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_VST3Bridge_uint64_t_0_8_void_ptr_8_16 $s10VST3Bridge0A17PluginDescriptionV7versionSSvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_VST3Bridge_uint64_t_0_8_void_ptr_8_16 $s10VST3Bridge0A17PluginDescriptionV8categorySSvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_VST3Bridge_uint64_t_0_8_void_ptr_8_16 $s10VST3Bridge0A17PluginDescriptionV7classIDSSvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN bool $s10VST3Bridge0A17PluginDescriptionV9hasEditorSbvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN bool $s10VST3Bridge0A17PluginDescriptionV7isSynthSbvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN ptrdiff_t $s10VST3Bridge0A17PluginDescriptionV14numAudioInputsSivg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN ptrdiff_t $s10VST3Bridge0A17PluginDescriptionV15numAudioOutputsSivg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
struct VST3Bridge_VST3PluginDescription {
  _Alignas(8) char _storage[120];
};

SWIFT_EXTERN struct swift_interop_returnStub_VST3Bridge_void_ptr_0_8 $s10VST3Bridge0A7ScannerC18defaultSearchPathsSaySSGvgZ(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_VST3Bridge_void_ptr_0_8 $s10VST3Bridge0A7ScannerC20scanDefaultLocationsSayAA0A17PluginDescriptionVGyFZ(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // scanDefaultLocations()
SWIFT_EXTERN struct swift_interop_returnStub_VST3Bridge_uint64_t_0_8 $s10VST3Bridge0A7ScannerC13scanDirectoryySayAA0A17PluginDescriptionVGSgSSFZ(struct swift_interop_passStub_VST3Bridge_uint64_t_0_8_void_ptr_8_16 path, SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // scanDirectory(_:)
SWIFT_EXTERN struct swift_interop_returnStub_VST3Bridge_uint64_t_0_8_void_ptr_8_16 $s10VST3Bridge0A7ScannerC9lastErrorSSvgZ(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_VST3Bridge_uint64_t_0_8_void_ptr_8_16 $s10VST3Bridge0A7ScannerC10sdkVersionSSvgZ(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
...
class SWIFT_SYMBOL("s:10VST3Bridge0A9ParameterV") VST3Parameter;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
inline const constexpr bool isUsableInGenericContext<VST3Bridge::VST3Parameter> = true;
#pragma clang diagnostic pop
} // namespace swift

namespace VST3Bridge SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("VST3Bridge") {
class SWIFT_SYMBOL("s:10VST3Bridge0A13MIDIEventDataV") VST3MIDIEventData;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
inline const constexpr bool isUsableInGenericContext<VST3Bridge::VST3MIDIEventData> = true;
#pragma clang diagnostic pop
} // namespace swift

namespace VST3Bridge SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("VST3Bridge") {
class SWIFT_SYMBOL("s:10VST3Bridge0A8InstanceC") VST3Instance;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
inline const constexpr bool isUsableInGenericContext<VST3Bridge::VST3Instance> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_VST3Instance;
// Type metadata accessor for VST3Instance
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s10VST3Bridge0A8InstanceCMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:10VST3Bridge0A8InstanceC") VST3Instance final : public swift::_impl::RefCountedClass {
public:
  using RefCountedClass::RefCountedClass;
  using RefCountedClass::operator=;
  SWIFT_INLINE_THUNK swift::Array<VST3Parameter> getParameters() SWIFT_SYMBOL("s:10VST3Bridge0A8InstanceC10parametersSayAA0A9ParameterVGvp");
  SWIFT_INLINE_THUNK void setParameters(const swift::Array<VST3Parameter>& value) SWIFT_SYMBOL("s:10VST3Bridge0A8InstanceC10parametersSayAA0A9ParameterVGvp");
  SWIFT_INLINE_THUNK bool isSetUp() SWIFT_SYMBOL("s:10VST3Bridge0A8InstanceC7isSetUpSbvp");
  SWIFT_INLINE_THUNK void setIsSetUp(bool value) SWIFT_SYMBOL("s:10VST3Bridge0A8InstanceC7isSetUpSbvp");
  SWIFT_INLINE_THUNK bool isActive() SWIFT_SYMBOL("s:10VST3Bridge0A8InstanceC8isActiveSbvp");
  SWIFT_INLINE_THUNK void setIsActive(bool value) SWIFT_SYMBOL("s:10VST3Bridge0A8InstanceC8isActiveSbvp");
/// Set up audio processing
  SWIFT_INLINE_THUNK bool setup(swift::Int sampleRate, swift::Int maxBlockSize, swift::Int numChannels) SWIFT_SYMBOL("s:10VST3Bridge0A8InstanceC5setup10sampleRate12maxBlockSize11numChannelsSbSi_S2itF");
/// Activate the plugin
  SWIFT_INLINE_THUNK bool activate() SWIFT_SYMBOL("s:10VST3Bridge0A8InstanceC8activateSbyF");
/// Deactivate the plugin
  SWIFT_INLINE_THUNK bool deactivate() SWIFT_SYMBOL("s:10VST3Bridge0A8InstanceC10deactivateSbyF");
/// Process audio buffers
  SWIFT_INLINE_THUNK bool process(const swift::Array<swift::Array<float>>& inputs, swift::Array<swift::Array<float>>& outputs, const swift::Array<VST3MIDIEventData>& midiEvents) SWIFT_SYMBOL("s:10VST3Bridge0A8InstanceC7process6inputs7outputs10midiEventsSbSaySaySfGG_AIzSayAA0A13MIDIEventDataVGtF");
/// Get parameter value
  SWIFT_INLINE_THUNK double getParameter(uint32_t id) SWIFT_SYMBOL("s:10VST3Bridge0A8InstanceC12getParameterySds6UInt32VF");
/// Set parameter value
  SWIFT_INLINE_THUNK void setParameter(uint32_t id, double value) SWIFT_SYMBOL("s:10VST3Bridge0A8InstanceC12setParameter_5valueys6UInt32V_SdtF");
/// Begin parameter edit gesture
  SWIFT_INLINE_THUNK void beginEdit(uint32_t id) SWIFT_SYMBOL("s:10VST3Bridge0A8InstanceC9beginEdityys6UInt32VF");
/// End parameter edit gesture
  SWIFT_INLINE_THUNK void endEdit(uint32_t id) SWIFT_SYMBOL("s:10VST3Bridge0A8InstanceC7endEdityys6UInt32VF");
  SWIFT_INLINE_THUNK bool hasEditor() SWIFT_SYMBOL("s:10VST3Bridge0A8InstanceC9hasEditorSbvp");
/// Open editor in a parent view
  #if defined(__OBJC__)
SWIFT_INLINE_THUNK bool openEditor(id _Nonnull parentView) SWIFT_SYMBOL("s:10VST3Bridge0A8InstanceC10openEditor2inSbyXl_tF");
#endif
/// Close editor
  SWIFT_INLINE_THUNK void closeEditor() SWIFT_SYMBOL("s:10VST3Bridge0A8InstanceC11closeEditoryyF");
protected:
  SWIFT_INLINE_THUNK VST3Instance(void * _Nonnull ptr) noexcept : RefCountedClass(ptr) {}
private:
  friend class _impl::_impl_VST3Instance;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s10VST3Bridge0A8InstanceCD;
  static inline constexpr $s10VST3Bridge0A8InstanceCD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_VST3Instance {
public:
static SWIFT_INLINE_THUNK VST3Instance makeRetained(void * _Nonnull ptr) noexcept { return VST3Instance(ptr); }
};
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<VST3Bridge::VST3Instance> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return VST3Bridge::_impl::$s10VST3Bridge0A8InstanceCMa(0)._0;
  }
};
namespace _impl{
template<>
struct implClassFor<VST3Bridge::VST3Instance> { using type = VST3Bridge::_impl::_impl_VST3Instance; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_VST3MIDIEventData;

// Type metadata accessor for VST3MIDIEventData
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s10VST3Bridge0A13MIDIEventDataVMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:10VST3Bridge0A13MIDIEventDataV") VST3MIDIEventData final {
public:
  SWIFT_INLINE_THUNK ~VST3MIDIEventData() noexcept {
    auto metadata = _impl::$s10VST3Bridge0A13MIDIEventDataVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK VST3MIDIEventData(const VST3MIDIEventData &other) noexcept {
    auto metadata = _impl::$s10VST3Bridge0A13MIDIEventDataVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK VST3MIDIEventData &operator =(const VST3MIDIEventData &other) noexcept {
    auto metadata = _impl::$s10VST3Bridge0A13MIDIEventDataVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK VST3MIDIEventData &operator =(VST3MIDIEventData &&other) = delete;
  [[noreturn]] SWIFT_INLINE_PRIVATE_HELPER VST3MIDIEventData(VST3MIDIEventData &&) noexcept {
  swift::_impl::_fatalError_Cxx_move_of_Swift_value_type_not_supported_yet();
  swift::_impl::_swift_stdlib_reportFatalError("swift", 5, "C++ does not support moving a Swift value yet", 45, 0);
  abort();
  }
  SWIFT_INLINE_THUNK swift::Int getSampleOffset() const SWIFT_SYMBOL("s:10VST3Bridge0A13MIDIEventDataV12sampleOffsetSivp");
  SWIFT_INLINE_THUNK void setSampleOffset(swift::Int value) SWIFT_SYMBOL("s:10VST3Bridge0A13MIDIEventDataV12sampleOffsetSivp");
  SWIFT_INLINE_THUNK uint8_t getStatus() const SWIFT_SYMBOL("s:10VST3Bridge0A13MIDIEventDataV6statuss5UInt8Vvp");
  SWIFT_INLINE_THUNK void setStatus(uint8_t value) SWIFT_SYMBOL("s:10VST3Bridge0A13MIDIEventDataV6statuss5UInt8Vvp");
  SWIFT_INLINE_THUNK uint8_t getData1() const SWIFT_SYMBOL("s:10VST3Bridge0A13MIDIEventDataV5data1s5UInt8Vvp");
  SWIFT_INLINE_THUNK void setData1(uint8_t value) SWIFT_SYMBOL("s:10VST3Bridge0A13MIDIEventDataV5data1s5UInt8Vvp");
  SWIFT_INLINE_THUNK uint8_t getData2() const SWIFT_SYMBOL("s:10VST3Bridge0A13MIDIEventDataV5data2s5UInt8Vvp");
  SWIFT_INLINE_THUNK void setData2(uint8_t value) SWIFT_SYMBOL("s:10VST3Bridge0A13MIDIEventDataV5data2s5UInt8Vvp");
  SWIFT_INLINE_THUNK uint8_t getChannel() const SWIFT_SYMBOL("s:10VST3Bridge0A13MIDIEventDataV7channels5UInt8Vvp");
  SWIFT_INLINE_THUNK void setChannel(uint8_t value) SWIFT_SYMBOL("s:10VST3Bridge0A13MIDIEventDataV7channels5UInt8Vvp");
  static SWIFT_INLINE_THUNK VST3MIDIEventData init(swift::Int sampleOffset, uint8_t status, uint8_t data1, uint8_t data2, uint8_t channel) SWIFT_SYMBOL("s:10VST3Bridge0A13MIDIEventDataV12sampleOffset6status5data15data27channelACSi_s5UInt8VA3Jtcfc");
/// Create a note on event
  static SWIFT_INLINE_THUNK VST3MIDIEventData noteOn(swift::Int sampleOffset, uint8_t note, uint8_t velocity, uint8_t channel) SWIFT_SYMBOL("s:10VST3Bridge0A13MIDIEventDataV6noteOn12sampleOffset0E08velocity7channelACSi_s5UInt8VA2JtFZ");
/// Create a note off event
  static SWIFT_INLINE_THUNK VST3MIDIEventData noteOff(swift::Int sampleOffset, uint8_t note, uint8_t velocity, uint8_t channel) SWIFT_SYMBOL("s:10VST3Bridge0A13MIDIEventDataV7noteOff12sampleOffset0E08velocity7channelACSi_s5UInt8VA2JtFZ");
private:
  SWIFT_INLINE_THUNK VST3MIDIEventData() noexcept {}
  static SWIFT_INLINE_THUNK VST3MIDIEventData _make() noexcept { return VST3MIDIEventData(); }
  SWIFT_INLINE_THUNK const char * _Nonnull _getOpaquePointer() const noexcept { return _storage; }
  SWIFT_INLINE_THUNK char * _Nonnull _getOpaquePointer() noexcept { return _storage; }

  alignas(8) char _storage[12];
  friend class _impl::_impl_VST3MIDIEventData;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s10VST3Bridge0A13MIDIEventDataVD;
  static inline constexpr $s10VST3Bridge0A13MIDIEventDataVD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_VST3MIDIEventData {
public:
  static SWIFT_INLINE_THUNK char * _Nonnull getOpaquePointer(VST3MIDIEventData &object) { return object._getOpaquePointer(); }
  static SWIFT_INLINE_THUNK const char * _Nonnull getOpaquePointer(const VST3MIDIEventData &object) { return object._getOpaquePointer(); }
  template<class T>
  static SWIFT_INLINE_PRIVATE_HELPER VST3MIDIEventData returnNewValue(T callable) {
    auto result = VST3MIDIEventData::_make();
    callable(result._getOpaquePointer());
    return result;
  }
  static SWIFT_INLINE_THUNK void initializeWithTake(char * _Nonnull destStorage, char * _Nonnull srcStorage) {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<VST3Bridge::VST3MIDIEventData> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return VST3Bridge::_impl::$s10VST3Bridge0A13MIDIEventDataVMa(0)._0;
  }
};
namespace _impl{
template<>
inline const constexpr bool isValueType<VST3Bridge::VST3MIDIEventData> = true;
template<>
struct implClassFor<VST3Bridge::VST3MIDIEventData> { using type = VST3Bridge::_impl::_impl_VST3MIDIEventData; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:10VST3Bridge0A17PluginDescriptionV") VST3PluginDescription;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
inline const constexpr bool isUsableInGenericContext<VST3Bridge::VST3PluginDescription> = true;
#pragma clang diagnostic pop
} // namespace swift

namespace VST3Bridge SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("VST3Bridge") {
class SWIFT_SYMBOL("s:10VST3Bridge0A6ModuleC") VST3Module;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
inline const constexpr bool isUsableInGenericContext<VST3Bridge::VST3Module> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_VST3Module;
// Type metadata accessor for VST3Module
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s10VST3Bridge0A6ModuleCMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:10VST3Bridge0A6ModuleC") VST3Module final : public swift::_impl::RefCountedClass {
public:
  using RefCountedClass::RefCountedClass;
  using RefCountedClass::operator=;
  SWIFT_INLINE_THUNK swift::String getPath() SWIFT_SYMBOL("s:10VST3Bridge0A6ModuleC4pathSSvp");
  SWIFT_INLINE_THUNK swift::Array<VST3PluginDescription> getPlugins() SWIFT_SYMBOL("s:10VST3Bridge0A6ModuleC7pluginsSayAA0A17PluginDescriptionVGvp");
  SWIFT_INLINE_THUNK void setPlugins(const swift::Array<VST3PluginDescription>& value) SWIFT_SYMBOL("s:10VST3Bridge0A6ModuleC7pluginsSayAA0A17PluginDescriptionVGvp");
  static SWIFT_INLINE_THUNK swift::Optional<VST3Module> init(const swift::String& path) SWIFT_SYMBOL("s:10VST3Bridge0A6ModuleC4pathACSgSS_tcfc");
/// Create an instance of a plugin
  SWIFT_INLINE_THUNK swift::Optional<VST3Instance> createInstance(swift::Int pluginIndex) SWIFT_SYMBOL("s:10VST3Bridge0A6ModuleC14createInstance11pluginIndexAA0aE0CSgSi_tF");
protected:
  SWIFT_INLINE_THUNK VST3Module(void * _Nonnull ptr) noexcept : RefCountedClass(ptr) {}
private:
  friend class _impl::_impl_VST3Module;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s10VST3Bridge0A6ModuleCD;
  static inline constexpr $s10VST3Bridge0A6ModuleCD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_VST3Module {
public:
static SWIFT_INLINE_THUNK VST3Module makeRetained(void * _Nonnull ptr) noexcept { return VST3Module(ptr); }
};
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<VST3Bridge::VST3Module> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return VST3Bridge::_impl::$s10VST3Bridge0A6ModuleCMa(0)._0;
  }
};
namespace _impl{
template<>
struct implClassFor<VST3Bridge::VST3Module> { using type = VST3Bridge::_impl::_impl_VST3Module; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_VST3Parameter;

// Type metadata accessor for VST3Parameter
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s10VST3Bridge0A9ParameterVMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:10VST3Bridge0A9ParameterV") VST3Parameter final {
public:
  SWIFT_INLINE_THUNK ~VST3Parameter() noexcept {
    auto metadata = _impl::$s10VST3Bridge0A9ParameterVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK VST3Parameter(const VST3Parameter &other) noexcept {
    auto metadata = _impl::$s10VST3Bridge0A9ParameterVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK VST3Parameter &operator =(const VST3Parameter &other) noexcept {
    auto metadata = _impl::$s10VST3Bridge0A9ParameterVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK VST3Parameter &operator =(VST3Parameter &&other) = delete;
  [[noreturn]] SWIFT_INLINE_PRIVATE_HELPER VST3Parameter(VST3Parameter &&) noexcept {
  swift::_impl::_fatalError_Cxx_move_of_Swift_value_type_not_supported_yet();
  swift::_impl::_swift_stdlib_reportFatalError("swift", 5, "C++ does not support moving a Swift value yet", 45, 0);
  abort();
  }
  SWIFT_INLINE_THUNK uint32_t getId() const SWIFT_SYMBOL("s:10VST3Bridge0A9ParameterV2ids6UInt32Vvp");
  SWIFT_INLINE_THUNK swift::String getName() const SWIFT_SYMBOL("s:10VST3Bridge0A9ParameterV4nameSSvp");
  SWIFT_INLINE_THUNK swift::String getShortName() const SWIFT_SYMBOL("s:10VST3Bridge0A9ParameterV9shortNameSSvp");
  SWIFT_INLINE_THUNK swift::String getUnits() const SWIFT_SYMBOL("s:10VST3Bridge0A9ParameterV5unitsSSvp");
  SWIFT_INLINE_THUNK double getDefaultValue() const SWIFT_SYMBOL("s:10VST3Bridge0A9ParameterV12defaultValueSdvp");
  SWIFT_INLINE_THUNK double getMinValue() const SWIFT_SYMBOL("s:10VST3Bridge0A9ParameterV8minValueSdvp");
  SWIFT_INLINE_THUNK double getMaxValue() const SWIFT_SYMBOL("s:10VST3Bridge0A9ParameterV8maxValueSdvp");
  SWIFT_INLINE_THUNK swift::Int getStepCount() const SWIFT_SYMBOL("s:10VST3Bridge0A9ParameterV9stepCountSivp");
  SWIFT_INLINE_THUNK bool getCanAutomate() const SWIFT_SYMBOL("s:10VST3Bridge0A9ParameterV11canAutomateSbvp");
private:
  SWIFT_INLINE_THUNK VST3Parameter() noexcept {}
  static SWIFT_INLINE_THUNK VST3Parameter _make() noexcept { return VST3Parameter(); }
  SWIFT_INLINE_THUNK const char * _Nonnull _getOpaquePointer() const noexcept { return _storage; }
  SWIFT_INLINE_THUNK char * _Nonnull _getOpaquePointer() noexcept { return _storage; }

  alignas(8) char _storage[89];
  friend class _impl::_impl_VST3Parameter;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s10VST3Bridge0A9ParameterVD;
  static inline constexpr $s10VST3Bridge0A9ParameterVD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_VST3Parameter {
public:
  static SWIFT_INLINE_THUNK char * _Nonnull getOpaquePointer(VST3Parameter &object) { return object._getOpaquePointer(); }
  static SWIFT_INLINE_THUNK const char * _Nonnull getOpaquePointer(const VST3Parameter &object) { return object._getOpaquePointer(); }
  template<class T>
  static SWIFT_INLINE_PRIVATE_HELPER VST3Parameter returnNewValue(T callable) {
    auto result = VST3Parameter::_make();
    callable(result._getOpaquePointer());
    return result;
  }
  static SWIFT_INLINE_THUNK void initializeWithTake(char * _Nonnull destStorage, char * _Nonnull srcStorage) {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<VST3Bridge::VST3Parameter> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return VST3Bridge::_impl::$s10VST3Bridge0A9ParameterVMa(0)._0;
  }
};
namespace _impl{
template<>
inline const constexpr bool isValueType<VST3Bridge::VST3Parameter> = true;
template<>
struct implClassFor<VST3Bridge::VST3Parameter> { using type = VST3Bridge::_impl::_impl_VST3Parameter; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_VST3PluginDescription;

// Type metadata accessor for VST3PluginDescription
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s10VST3Bridge0A17PluginDescriptionVMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:10VST3Bridge0A17PluginDescriptionV") VST3PluginDescription final {
public:
  SWIFT_INLINE_THUNK ~VST3PluginDescription() noexcept {
    auto metadata = _impl::$s10VST3Bridge0A17PluginDescriptionVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK VST3PluginDescription(const VST3PluginDescription &other) noexcept {
    auto metadata = _impl::$s10VST3Bridge0A17PluginDescriptionVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK VST3PluginDescription &operator =(const VST3PluginDescription &other) noexcept {
    auto metadata = _impl::$s10VST3Bridge0A17PluginDescriptionVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK VST3PluginDescription &operator =(VST3PluginDescription &&other) = delete;
  [[noreturn]] SWIFT_INLINE_PRIVATE_HELPER VST3PluginDescription(VST3PluginDescription &&) noexcept {
  swift::_impl::_fatalError_Cxx_move_of_Swift_value_type_not_supported_yet();
  swift::_impl::_swift_stdlib_reportFatalError("swift", 5, "C++ does not support moving a Swift value yet", 45, 0);
  abort();
  }
  SWIFT_INLINE_THUNK swift::String getId() const SWIFT_SYMBOL("s:10VST3Bridge0A17PluginDescriptionV2idSSvp");
  SWIFT_INLINE_THUNK swift::String getName() const SWIFT_SYMBOL("s:10VST3Bridge0A17PluginDescriptionV4nameSSvp");
  SWIFT_INLINE_THUNK swift::String getVendor() const SWIFT_SYMBOL("s:10VST3Bridge0A17PluginDescriptionV6vendorSSvp");
  SWIFT_INLINE_THUNK swift::String getVersion() const SWIFT_SYMBOL("s:10VST3Bridge0A17PluginDescriptionV7versionSSvp");
  SWIFT_INLINE_THUNK swift::String getCategory() const SWIFT_SYMBOL("s:10VST3Bridge0A17PluginDescriptionV8categorySSvp");
  SWIFT_INLINE_THUNK swift::String getClassID() const SWIFT_SYMBOL("s:10VST3Bridge0A17PluginDescriptionV7classIDSSvp");
  SWIFT_INLINE_THUNK bool hasEditor() const SWIFT_SYMBOL("s:10VST3Bridge0A17PluginDescriptionV9hasEditorSbvp");
  SWIFT_INLINE_THUNK bool isSynth() const SWIFT_SYMBOL("s:10VST3Bridge0A17PluginDescriptionV7isSynthSbvp");
  SWIFT_INLINE_THUNK swift::Int getNumAudioInputs() const SWIFT_SYMBOL("s:10VST3Bridge0A17PluginDescriptionV14numAudioInputsSivp");
  SWIFT_INLINE_THUNK swift::Int getNumAudioOutputs() const SWIFT_SYMBOL("s:10VST3Bridge0A17PluginDescriptionV15numAudioOutputsSivp");
private:
  SWIFT_INLINE_THUNK VST3PluginDescription() noexcept {}
  static SWIFT_INLINE_THUNK VST3PluginDescription _make() noexcept { return VST3PluginDescription(); }
  SWIFT_INLINE_THUNK const char * _Nonnull _getOpaquePointer() const noexcept { return _storage; }
  SWIFT_INLINE_THUNK char * _Nonnull _getOpaquePointer() noexcept { return _storage; }

  alignas(8) char _storage[120];
  friend class _impl::_impl_VST3PluginDescription;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s10VST3Bridge0A17PluginDescriptionVD;
  static inline constexpr $s10VST3Bridge0A17PluginDescriptionVD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_VST3PluginDescription {
public:
  static SWIFT_INLINE_THUNK char * _Nonnull getOpaquePointer(VST3PluginDescription &object) { return object._getOpaquePointer(); }
  static SWIFT_INLINE_THUNK const char * _Nonnull getOpaquePointer(const VST3PluginDescription &object) { return object._getOpaquePointer(); }
  template<class T>
  static SWIFT_INLINE_PRIVATE_HELPER VST3PluginDescription returnNewValue(T callable) {
    auto result = VST3PluginDescription::_make();
    callable(result._getOpaquePointer());
    return result;
  }
  static SWIFT_INLINE_THUNK void initializeWithTake(char * _Nonnull destStorage, char * _Nonnull srcStorage) {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<VST3Bridge::VST3PluginDescription> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return VST3Bridge::_impl::$s10VST3Bridge0A17PluginDescriptionVMa(0)._0;
  }
};
namespace _impl{
template<>
inline const constexpr bool isValueType<VST3Bridge::VST3PluginDescription> = true;
template<>
struct implClassFor<VST3Bridge::VST3PluginDescription> { using type = VST3Bridge::_impl::_impl_VST3PluginDescription; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:10VST3Bridge0A7ScannerC") VST3Scanner;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
inline const constexpr bool isUsableInGenericContext<VST3Bridge::VST3Scanner> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_VST3Scanner;
// Type metadata accessor for VST3Scanner
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s10VST3Bridge0A7ScannerCMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:10VST3Bridge0A7ScannerC") VST3Scanner final : public swift::_impl::RefCountedClass {
public:
  using RefCountedClass::RefCountedClass;
  using RefCountedClass::operator=;
  static SWIFT_INLINE_THUNK swift::Array<swift::String> getDefaultSearchPaths() SWIFT_SYMBOL("s:10VST3Bridge0A7ScannerC18defaultSearchPathsSaySSGvpZ");
/// Scan all default locations
  static SWIFT_INLINE_THUNK swift::Array<VST3PluginDescription> scanDefaultLocations() SWIFT_SYMBOL("s:10VST3Bridge0A7ScannerC20scanDefaultLocationsSayAA0A17PluginDescriptionVGyFZ");
/// Scan a specific directory
  static SWIFT_INLINE_THUNK swift::Optional<swift::Array<VST3PluginDescription>> scanDirectory(const swift::String& path) SWIFT_SYMBOL("s:10VST3Bridge0A7ScannerC13scanDirectoryySayAA0A17PluginDescriptionVGSgSSFZ");
  static SWIFT_INLINE_THUNK swift::String getLastError() SWIFT_SYMBOL("s:10VST3Bridge0A7ScannerC9lastErrorSSvpZ");
  static SWIFT_INLINE_THUNK swift::String getSdkVersion() SWIFT_SYMBOL("s:10VST3Bridge0A7ScannerC10sdkVersionSSvpZ");
protected:
  SWIFT_INLINE_THUNK VST3Scanner(void * _Nonnull ptr) noexcept : RefCountedClass(ptr) {}
private:
  friend class _impl::_impl_VST3Scanner;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s10VST3Bridge0A7ScannerCD;
  static inline constexpr $s10VST3Bridge0A7ScannerCD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_VST3Scanner {
public:
static SWIFT_INLINE_THUNK VST3Scanner makeRetained(void * _Nonnull ptr) noexcept { return VST3Scanner(ptr); }
};
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<VST3Bridge::VST3Scanner> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return VST3Bridge::_impl::$s10VST3Bridge0A7ScannerCMa(0)._0;
  }
};
namespace _impl{
template<>
struct implClassFor<VST3Bridge::VST3Scanner> { using type = VST3Bridge::_impl::_impl_VST3Scanner; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
namespace VST3Bridge SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("VST3Bridge") {
  ...
  SWIFT_INLINE_THUNK swift::Array<VST3Parameter> VST3Instance::getParameters() {
  return swift::_impl::_impl_Array<VST3Parameter>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    VST3Bridge::_impl::swift_interop_returnDirect_VST3Bridge_void_ptr_0_8(result, VST3Bridge::_impl::$s10VST3Bridge0A8InstanceC10parametersSayAA0A9ParameterVGvg(::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this)));
  });
  }
  SWIFT_INLINE_THUNK void VST3Instance::setParameters(const swift::Array<VST3Parameter>& value) {
  alignas(alignof(swift::Array<VST3Parameter>)) char copyBuffer_consumedParamCopy_value[sizeof(swift::Array<VST3Parameter>)];
  auto &consumedParamCopy_value = *(new(copyBuffer_consumedParamCopy_value) swift::Array<VST3Parameter>(value));
  swift::_impl::ConsumedValueStorageDestroyer<swift::Array<VST3Parameter>> storageGuard_consumedParamCopy_value(consumedParamCopy_value);
  VST3Bridge::_impl::$s10VST3Bridge0A8InstanceC10parametersSayAA0A9ParameterVGvs(VST3Bridge::_impl::swift_interop_passDirect_VST3Bridge_void_ptr_0_8(swift::_impl::_impl_Array<VST3Parameter>::getOpaquePointer(consumedParamCopy_value)), ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK bool VST3Instance::isSetUp() {
  return VST3Bridge::_impl::$s10VST3Bridge0A8InstanceC7isSetUpSbvg(::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK void VST3Instance::setIsSetUp(bool value) {
  VST3Bridge::_impl::$s10VST3Bridge0A8InstanceC7isSetUpSbvs(value, ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK bool VST3Instance::isActive() {
  return VST3Bridge::_impl::$s10VST3Bridge0A8InstanceC8isActiveSbvg(::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK void VST3Instance::setIsActive(bool value) {
  VST3Bridge::_impl::$s10VST3Bridge0A8InstanceC8isActiveSbvs(value, ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK bool VST3Instance::setup(swift::Int sampleRate, swift::Int maxBlockSize, swift::Int numChannels) {
  return VST3Bridge::_impl::$s10VST3Bridge0A8InstanceC5setup10sampleRate12maxBlockSize11numChannelsSbSi_S2itF(sampleRate, maxBlockSize, numChannels, ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK bool VST3Instance::activate() {
  return VST3Bridge::_impl::$s10VST3Bridge0A8InstanceC8activateSbyF(::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK bool VST3Instance::deactivate() {
  return VST3Bridge::_impl::$s10VST3Bridge0A8InstanceC10deactivateSbyF(::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK bool VST3Instance::process(const swift::Array<swift::Array<float>>& inputs, swift::Array<swift::Array<float>>& outputs, const swift::Array<VST3MIDIEventData>& midiEvents) {
  return VST3Bridge::_impl::$s10VST3Bridge0A8InstanceC7process6inputs7outputs10midiEventsSbSaySaySfGG_AIzSayAA0A13MIDIEventDataVGtF(VST3Bridge::_impl::swift_interop_passDirect_VST3Bridge_void_ptr_0_8(swift::_impl::_impl_Array<swift::Array<float>>::getOpaquePointer(inputs)), swift::_impl::_impl_Array<swift::Array<float>>::getOpaquePointer(outputs), VST3Bridge::_impl::swift_interop_passDirect_VST3Bridge_void_ptr_0_8(swift::_impl::_impl_Array<VST3MIDIEventData>::getOpaquePointer(midiEvents)), ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK double VST3Instance::getParameter(uint32_t id) {
  return VST3Bridge::_impl::$s10VST3Bridge0A8InstanceC12getParameterySds6UInt32VF(id, ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK void VST3Instance::setParameter(uint32_t id, double value) {
  VST3Bridge::_impl::$s10VST3Bridge0A8InstanceC12setParameter_5valueys6UInt32V_SdtF(id, value, ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK void VST3Instance::beginEdit(uint32_t id) {
  VST3Bridge::_impl::$s10VST3Bridge0A8InstanceC9beginEdityys6UInt32VF(id, ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK void VST3Instance::endEdit(uint32_t id) {
  VST3Bridge::_impl::$s10VST3Bridge0A8InstanceC7endEdityys6UInt32VF(id, ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK bool VST3Instance::hasEditor() {
  return VST3Bridge::_impl::$s10VST3Bridge0A8InstanceC9hasEditorSbvg(::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  #if defined(__OBJC__)
SWIFT_INLINE_THUNK bool VST3Instance::openEditor(id _Nonnull parentView) {
  return VST3Bridge::_impl::$s10VST3Bridge0A8InstanceC10openEditor2inSbyXl_tF(parentView, ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
#endif
  SWIFT_INLINE_THUNK void VST3Instance::closeEditor() {
  VST3Bridge::_impl::$s10VST3Bridge0A8InstanceC11closeEditoryyF(::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK swift::Int VST3MIDIEventData::getSampleOffset() const {
  return VST3Bridge::_impl::$s10VST3Bridge0A13MIDIEventDataV12sampleOffsetSivg(VST3Bridge::_impl::swift_interop_passDirect_VST3Bridge_uint64_t_0_8_uint32_t_8_12(_getOpaquePointer()));
  }
  SWIFT_INLINE_THUNK void VST3MIDIEventData::setSampleOffset(swift::Int value) {
  VST3Bridge::_impl::$s10VST3Bridge0A13MIDIEventDataV12sampleOffsetSivs(value, _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK uint8_t VST3MIDIEventData::getStatus() const {
  return VST3Bridge::_impl::$s10VST3Bridge0A13MIDIEventDataV6statuss5UInt8Vvg(VST3Bridge::_impl::swift_interop_passDirect_VST3Bridge_uint64_t_0_8_uint32_t_8_12(_getOpaquePointer()));
  }
  SWIFT_INLINE_THUNK void VST3MIDIEventData::setStatus(uint8_t value) {
  VST3Bridge::_impl::$s10VST3Bridge0A13MIDIEventDataV6statuss5UInt8Vvs(value, _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK uint8_t VST3MIDIEventData::getData1() const {
  return VST3Bridge::_impl::$s10VST3Bridge0A13MIDIEventDataV5data1s5UInt8Vvg(VST3Bridge::_impl::swift_interop_passDirect_VST3Bridge_uint64_t_0_8_uint32_t_8_12(_getOpaquePointer()));
  }
  SWIFT_INLINE_THUNK void VST3MIDIEventData::setData1(uint8_t value) {
  VST3Bridge::_impl::$s10VST3Bridge0A13MIDIEventDataV5data1s5UInt8Vvs(value, _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK uint8_t VST3MIDIEventData::getData2() const {
  return VST3Bridge::_impl::$s10VST3Bridge0A13MIDIEventDataV5data2s5UInt8Vvg(VST3Bridge::_impl::swift_interop_passDirect_VST3Bridge_uint64_t_0_8_uint32_t_8_12(_getOpaquePointer()));
  }
  SWIFT_INLINE_THUNK void VST3MIDIEventData::setData2(uint8_t value) {
  VST3Bridge::_impl::$s10VST3Bridge0A13MIDIEventDataV5data2s5UInt8Vvs(value, _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK uint8_t VST3MIDIEventData::getChannel() const {
  return VST3Bridge::_impl::$s10VST3Bridge0A13MIDIEventDataV7channels5UInt8Vvg(VST3Bridge::_impl::swift_interop_passDirect_VST3Bridge_uint64_t_0_8_uint32_t_8_12(_getOpaquePointer()));
  }
  SWIFT_INLINE_THUNK void VST3MIDIEventData::setChannel(uint8_t value) {
  VST3Bridge::_impl::$s10VST3Bridge0A13MIDIEventDataV7channels5UInt8Vvs(value, _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK VST3MIDIEventData VST3MIDIEventData::init(swift::Int sampleOffset, uint8_t status, uint8_t data1, uint8_t data2, uint8_t channel) {
  return VST3Bridge::_impl::_impl_VST3MIDIEventData::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    VST3Bridge::_impl::swift_interop_returnDirect_VST3Bridge_uint64_t_0_8_uint32_t_8_12(result, VST3Bridge::_impl::$s10VST3Bridge0A13MIDIEventDataV12sampleOffset6status5data15data27channelACSi_s5UInt8VA3JtcfC(sampleOffset, status, data1, data2, channel));
  });
  }
  SWIFT_INLINE_THUNK VST3MIDIEventData VST3MIDIEventData::noteOn(swift::Int sampleOffset, uint8_t note, uint8_t velocity, uint8_t channel) {
  return VST3Bridge::_impl::_impl_VST3MIDIEventData::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    VST3Bridge::_impl::swift_interop_returnDirect_VST3Bridge_uint64_t_0_8_uint32_t_8_12(result, VST3Bridge::_impl::$s10VST3Bridge0A13MIDIEventDataV6noteOn12sampleOffset0E08velocity7channelACSi_s5UInt8VA2JtFZ(sampleOffset, note, velocity, channel));
  });
  }
  SWIFT_INLINE_THUNK VST3MIDIEventData VST3MIDIEventData::noteOff(swift::Int sampleOffset, uint8_t note, uint8_t velocity, uint8_t channel) {
  return VST3Bridge::_impl::_impl_VST3MIDIEventData::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    VST3Bridge::_impl::swift_interop_returnDirect_VST3Bridge_uint64_t_0_8_uint32_t_8_12(result, VST3Bridge::_impl::$s10VST3Bridge0A13MIDIEventDataV7noteOff12sampleOffset0E08velocity7channelACSi_s5UInt8VA2JtFZ(sampleOffset, note, velocity, channel));
  });
  }
  SWIFT_INLINE_THUNK swift::String VST3Module::getPath() {
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    VST3Bridge::_impl::swift_interop_returnDirect_VST3Bridge_uint64_t_0_8_void_ptr_8_16(result, VST3Bridge::_impl::$s10VST3Bridge0A6ModuleC4pathSSvg(::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this)));
  });
  }
  SWIFT_INLINE_THUNK swift::Array<VST3PluginDescription> VST3Module::getPlugins() {
  return swift::_impl::_impl_Array<VST3PluginDescription>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    VST3Bridge::_impl::swift_interop_returnDirect_VST3Bridge_void_ptr_0_8(result, VST3Bridge::_impl::$s10VST3Bridge0A6ModuleC7pluginsSayAA0A17PluginDescriptionVGvg(::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this)));
  });
  }
  SWIFT_INLINE_THUNK void VST3Module::setPlugins(const swift::Array<VST3PluginDescription>& value) {
  alignas(alignof(swift::Array<VST3PluginDescription>)) char copyBuffer_consumedParamCopy_value[sizeof(swift::Array<VST3PluginDescription>)];
  auto &consumedParamCopy_value = *(new(copyBuffer_consumedParamCopy_value) swift::Array<VST3PluginDescription>(value));
  swift::_impl::ConsumedValueStorageDestroyer<swift::Array<VST3PluginDescription>> storageGuard_consumedParamCopy_value(consumedParamCopy_value);
  VST3Bridge::_impl::$s10VST3Bridge0A6ModuleC7pluginsSayAA0A17PluginDescriptionVGvs(VST3Bridge::_impl::swift_interop_passDirect_VST3Bridge_void_ptr_0_8(swift::_impl::_impl_Array<VST3PluginDescription>::getOpaquePointer(consumedParamCopy_value)), ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK swift::Optional<VST3Module> VST3Module::init(const swift::String& path) {
  ...
  return swift::_impl::_impl_Optional<VST3Module>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    VST3Bridge::_impl::swift_interop_returnDirect_VST3Bridge_uint64_t_0_8(result, VST3Bridge::_impl::$s10VST3Bridge0A6ModuleC4pathACSgSS_tcfC(VST3Bridge::_impl::swift_interop_passDirect_VST3Bridge_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(consumedParamCopy_path)), swift::TypeMetadataTrait<VST3Module>::getTypeMetadata()));
  });
  }
  SWIFT_INLINE_THUNK swift::Optional<VST3Instance> VST3Module::createInstance(swift::Int pluginIndex) {
  return swift::_impl::_impl_Optional<VST3Instance>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    VST3Bridge::_impl::swift_interop_returnDirect_VST3Bridge_uint64_t_0_8(result, VST3Bridge::_impl::$s10VST3Bridge0A6ModuleC14createInstance11pluginIndexAA0aE0CSgSi_tF(pluginIndex, ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this)));
  });
  }
  SWIFT_INLINE_THUNK uint32_t VST3Parameter::getId() const {
  return VST3Bridge::_impl::$s10VST3Bridge0A9ParameterV2ids6UInt32Vvg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK swift::String VST3Parameter::getName() const {
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    VST3Bridge::_impl::swift_interop_returnDirect_VST3Bridge_uint64_t_0_8_void_ptr_8_16(result, VST3Bridge::_impl::$s10VST3Bridge0A9ParameterV4nameSSvg(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK swift::String VST3Parameter::getShortName() const {
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    VST3Bridge::_impl::swift_interop_returnDirect_VST3Bridge_uint64_t_0_8_void_ptr_8_16(result, VST3Bridge::_impl::$s10VST3Bridge0A9ParameterV9shortNameSSvg(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK swift::String VST3Parameter::getUnits() const {
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    VST3Bridge::_impl::swift_interop_returnDirect_VST3Bridge_uint64_t_0_8_void_ptr_8_16(result, VST3Bridge::_impl::$s10VST3Bridge0A9ParameterV5unitsSSvg(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK double VST3Parameter::getDefaultValue() const {
  return VST3Bridge::_impl::$s10VST3Bridge0A9ParameterV12defaultValueSdvg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK double VST3Parameter::getMinValue() const {
  return VST3Bridge::_impl::$s10VST3Bridge0A9ParameterV8minValueSdvg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK double VST3Parameter::getMaxValue() const {
  return VST3Bridge::_impl::$s10VST3Bridge0A9ParameterV8maxValueSdvg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK swift::Int VST3Parameter::getStepCount() const {
  return VST3Bridge::_impl::$s10VST3Bridge0A9ParameterV9stepCountSivg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK bool VST3Parameter::getCanAutomate() const {
  return VST3Bridge::_impl::$s10VST3Bridge0A9ParameterV11canAutomateSbvg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK swift::String VST3PluginDescription::getId() const {
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    VST3Bridge::_impl::swift_interop_returnDirect_VST3Bridge_uint64_t_0_8_void_ptr_8_16(result, VST3Bridge::_impl::$s10VST3Bridge0A17PluginDescriptionV2idSSvg(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK swift::String VST3PluginDescription::getName() const {
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    VST3Bridge::_impl::swift_interop_returnDirect_VST3Bridge_uint64_t_0_8_void_ptr_8_16(result, VST3Bridge::_impl::$s10VST3Bridge0A17PluginDescriptionV4nameSSvg(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK swift::String VST3PluginDescription::getVendor() const {
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    VST3Bridge::_impl::swift_interop_returnDirect_VST3Bridge_uint64_t_0_8_void_ptr_8_16(result, VST3Bridge::_impl::$s10VST3Bridge0A17PluginDescriptionV6vendorSSvg(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK swift::String VST3PluginDescription::getVersion() const {
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    VST3Bridge::_impl::swift_interop_returnDirect_VST3Bridge_uint64_t_0_8_void_ptr_8_16(result, VST3Bridge::_impl::$s10VST3Bridge0A17PluginDescriptionV7versionSSvg(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK swift::String VST3PluginDescription::getCategory() const {
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    VST3Bridge::_impl::swift_interop_returnDirect_VST3Bridge_uint64_t_0_8_void_ptr_8_16(result, VST3Bridge::_impl::$s10VST3Bridge0A17PluginDescriptionV8categorySSvg(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK swift::String VST3PluginDescription::getClassID() const {
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    VST3Bridge::_impl::swift_interop_returnDirect_VST3Bridge_uint64_t_0_8_void_ptr_8_16(result, VST3Bridge::_impl::$s10VST3Bridge0A17PluginDescriptionV7classIDSSvg(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK bool VST3PluginDescription::hasEditor() const {
  return VST3Bridge::_impl::$s10VST3Bridge0A17PluginDescriptionV9hasEditorSbvg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK bool VST3PluginDescription::isSynth() const {
  return VST3Bridge::_impl::$s10VST3Bridge0A17PluginDescriptionV7isSynthSbvg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK swift::Int VST3PluginDescription::getNumAudioInputs() const {
  return VST3Bridge::_impl::$s10VST3Bridge0A17PluginDescriptionV14numAudioInputsSivg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK swift::Int VST3PluginDescription::getNumAudioOutputs() const {
  return VST3Bridge::_impl::$s10VST3Bridge0A17PluginDescriptionV15numAudioOutputsSivg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK swift::Array<swift::String> VST3Scanner::getDefaultSearchPaths() {
  return swift::_impl::_impl_Array<swift::String>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    VST3Bridge::_impl::swift_interop_returnDirect_VST3Bridge_void_ptr_0_8(result, VST3Bridge::_impl::$s10VST3Bridge0A7ScannerC18defaultSearchPathsSaySSGvgZ(swift::TypeMetadataTrait<VST3Scanner>::getTypeMetadata()));
  });
  }
  SWIFT_INLINE_THUNK swift::Array<VST3PluginDescription> VST3Scanner::scanDefaultLocations() {
  return swift::_impl::_impl_Array<VST3PluginDescription>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    VST3Bridge::_impl::swift_interop_returnDirect_VST3Bridge_void_ptr_0_8(result, VST3Bridge::_impl::$s10VST3Bridge0A7ScannerC20scanDefaultLocationsSayAA0A17PluginDescriptionVGyFZ(swift::TypeMetadataTrait<VST3Scanner>::getTypeMetadata()));
  });
  }
  SWIFT_INLINE_THUNK swift::Optional<swift::Array<VST3PluginDescription>> VST3Scanner::scanDirectory(const swift::String& path) {
  return swift::_impl::_impl_Optional<swift::Array<VST3PluginDescription>>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    VST3Bridge::_impl::swift_interop_returnDirect_VST3Bridge_uint64_t_0_8(result, VST3Bridge::_impl::$s10VST3Bridge0A7ScannerC13scanDirectoryySayAA0A17PluginDescriptionVGSgSSFZ(VST3Bridge::_impl::swift_interop_passDirect_VST3Bridge_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(path)), swift::TypeMetadataTrait<VST3Scanner>::getTypeMetadata()));
  });
  }
  SWIFT_INLINE_THUNK swift::String VST3Scanner::getLastError() {
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    VST3Bridge::_impl::swift_interop_returnDirect_VST3Bridge_uint64_t_0_8_void_ptr_8_16(result, VST3Bridge::_impl::$s10VST3Bridge0A7ScannerC9lastErrorSSvgZ(swift::TypeMetadataTrait<VST3Scanner>::getTypeMetadata()));
  });
  }
  SWIFT_INLINE_THUNK swift::String VST3Scanner::getSdkVersion() {
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    VST3Bridge::_impl::swift_interop_returnDirect_VST3Bridge_uint64_t_0_8_void_ptr_8_16(result, VST3Bridge::_impl::$s10VST3Bridge0A7ScannerC10sdkVersionSSvgZ(swift::TypeMetadataTrait<VST3Scanner>::getTypeMetadata()));
  });
  }
